...
from drop_words import drop_from_csv, drop_from_checkpoint
...
def sample_csv(tmp_path):
    ...
    rows = [
        {c: '' for c in CSV_COLUMNS} | {'単語': '下りる', 'レベル': 'N4'},
        {c: '' for c in CSV_COLUMNS} | {'単語': '招致', 'レベル': 'N4'},
        {c: '' for c in CSV_COLUMNS} | {'単語': '食べる', 'レベル': 'N4'},
    ]
